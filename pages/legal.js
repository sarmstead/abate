...
const Legal = () => {
  return (
    <Page>
      ...
      <p>Abate is a project created by <Link href='https://sunjayarmstead.com/about/'><a target='_blank'>Sunjay Armstead</a></Link>.</p>
      <p>Our service is free to use and all of our code is <Link href='https://github.com/sarmstead/abate'><a target='_blank'>open source</a></Link>.</p>
      ...
      <p>You may contact us at <Link href='https://sunjayarmstead.com/contact/'><a target='_blank'>sunjayarmstead.com/contact</a></Link> if you have any questions about the terms of using this application.</p>
    </Page>
  )
}
